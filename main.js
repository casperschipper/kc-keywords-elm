...
var author$project$Main$Research = F5(
	function (id, title, keywords, created, author) {
		return {author: author, created: created, id: id, keywords: keywords, title: title};
	});
...
var author$project$Main$viewKeywords = function (model) {
	return author$project$Main$renderKeywords(model.keywordDict);
};
...
var author$project$Main$viewResearchList = function (model) {
	var lowerQuery = elm$core$String$toLower(model.query);
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					A3(billstclair$elm_sortable_table$Table$view, author$project$Main$config, model.tableState, acceptableResearch)
				]))
		]);
};
