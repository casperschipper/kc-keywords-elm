...
var author$project$Main$researchByKeywordList = F2(
	function (sortedKeys, dict) {
		var renderRecord = function (research) {
			if (research.$ === 'Just') {
				if (!research.a.b) {
					return A2(
						elm$html$Html$span,
					...
					return A2(
						...
						A2(
							elm$core$List$map,
							A2(elm$core$Basics$composeL, author$project$Main$hyperlink, author$project$Main$makeLink),
							list));
				}
			} else {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('#keywords')
							]),
						_List_fromArray(
							[
		...
		var renderKey = A2(elm$core$Basics$composeL, author$project$Main$hyperlink, author$project$Main$keyToLinkInfo);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Main$renderKeywords = function (dict) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('keyword-list')
			]),
...
var author$project$Main$linkColumn = F2(
	function (name, toLink) {
		return billstclair$elm_sortable_table$Table$veryCustomColumn(
			{
				name: name,
				sorter: billstclair$elm_sortable_table$Table$increasingBy(
					A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$id('KC-portal-research')
							]),
						_List_fromArray(
							[
